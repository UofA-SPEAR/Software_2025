...
pkg_share = FindPackageShare(package='kipp_description').find('kipp_description')
config_rviz2 = os.path.join(pkg_share, 'rviz', 'kipp.rviz')

# URDF/xacro file to be loaded by the Robot State Publisher node
xacro_path = os.path.join(pkg_share, 'urdf','kipp.urdf.xacro')
